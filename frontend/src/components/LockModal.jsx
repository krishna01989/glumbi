    ...
    <div style={{
      ...
      <div style={{
        ...
        {lockModal === 'lock-verify' && <>
          ...
          <form onSubmit={e => { e.preventDefault(); onVerify() }} autoComplete="off">
