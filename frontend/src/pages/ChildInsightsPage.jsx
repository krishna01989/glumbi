          ...
          {allFeatures.length > 0 && (
            <div style={{ marginBottom: 20 }}>
              ...
              {allFeatures.map(({ feature, count, sec }) => {
                ...
                if (feature === 'stories' && data?.glumbiOtherEndings > 0)
                  extraChips.push({ key: 'g-alt', icon: '🔀', text: `Explored ${data.glumbiOtherEndings} alt ending${data.glumbiOtherEndings !== 1 ? 's' : ''}`, color: '#f59e0b', bg: '#fffbeb' })
