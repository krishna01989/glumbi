...
const FEATURES = [
  ...
  { emoji: '🐾', title: 'Trace & Play', desc: 'Guide a cow home, rocket to the moon, or bee to its flower — by tracing a winding path with your finger. Every level is a new AI-generated adventure.', grad: 'linear-gradient(135deg,#43e97b,#38f9d7)', tag: 'Motor skills', highlights: ['Touch-friendly', 'AI themes', 'All ages'] },
