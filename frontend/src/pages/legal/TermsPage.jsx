...
export default function TermsPage() {
  return (
    <LegalLayout title="Terms of Service" updated="30 June 2025">
      ...
      <ul>
        <li>Stories, activities, and curiosity answers are generated by Anthropic's Claude AI. While we apply multiple layers of content safety filtering, AI can occasionally produce unexpected output.</li>
